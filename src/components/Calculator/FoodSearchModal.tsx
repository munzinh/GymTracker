...
export function FoodSearchModal({ userId, onClose, onAdd }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col justify-end fade-in" style={{ background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)' }} onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="flex flex-col rounded-t-3xl overflow-hidden w-full max-w-md mx-auto" style={{ background: '#0a0a0a', maxHeight: '85dvh', borderTop: '1px solid rgba(255,255,255,0.08)', borderLeft: '1px solid rgba(255,255,255,0.06)', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                {/* Glass Header */}
                <div className="sticky top-0 z-20 bg-[#0a0a0a] backdrop-blur-xl border-b border-white/5 px-4 pt-2 pb-3 shrink-0">
